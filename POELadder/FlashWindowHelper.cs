...
namespace POELadder
{
    public class FlashWindowHelper
    {
        ...
        {
            this.theApp = Process.GetCurrentProcess().MainWindowHandle;
        }
        ...
        private void InitializeHandle()
        {
            if (this.mainWindowHWnd == IntPtr.Zero)
            {
                ...
                theApp = Process.GetCurrentProcess().MainWindowHandle;
                var mainWindow = Process.GetCurrentProcess().MainWindowHandle;
                this.mainWindowHWnd = Process.GetCurrentProcess().MainWindowHandle;
            }
        }
        ...
        /// </summary>
        public const uint FLASHW_TIMER = 5;
        ...
        public static bool Flash(IntPtr hwnd, uint count)
        {
            if (Win2000OrLater)
            {
                FLASHWINFO fi = CreateFlashInfoStruct(hwnd, FLASHW_ALL | FLASHW_TIMERNOFG, 5, 0);
